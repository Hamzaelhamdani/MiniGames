...
App({
  onLaunch() {
    ...
    const stats = wx.getStorageSync('solitaireStats');
    if (!stats) {
      wx.setStorageSync('solitaireStats', {
        gamesPlayed: 0,
        gamesWon: 0,
        bestTime: null,
        totalTime: 0
  ...
  updateStats(won, time) {
    ...
    wx.setStorageSync('solitaireStats', stats);
    return stats;
  },

  getStats() {
    return wx.getStorageSync('solitaireStats') || {
      gamesPlayed: 0,
      gamesWon: 0,
      bestTime: null,
      totalTime: 0
